...
use webauthn_rs_core::{
    ...
    proto::{
        ...
        COSEKeyType, CredentialProtectionPolicy, ExtnState, Attestation,
        AttestationData, RegisteredExtensions, Registration,
    },
};
...
use webauthn_rs_core::proto::SerializedAndParsedX509;
...
pub fn verify_fido_sk_ssh_attestation(
    ...
    let att_x509 = vec![SerializedAndParsedX509::from(ssh_sk_attest.att_cert.clone())];

    let attestation = Attestation {
        data: AttestationData::Basic(att_x509).into(),
